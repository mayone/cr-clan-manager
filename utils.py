...
def align_test():
	print("English characters (Halfwidth)")
	print("{0}{1}{2}".format(
				align("I"),
				align("am"),
				align("Wayne!")))
	print("Chinese characters (Fullwidth)")
	print("{0}{1}{2}".format(
				align("我"),
				align("是"),
				align("偉恩！")))
	print("Combining characters (Ambiguous)")
	print("{0}{1}{2}".format(
				align(u"I\u0304\u0304"),
				align(u"am\u0304\u0304"),
				align("W\u0304ayne\u0304!")))
	print("Built-in alignment method")
	print("{:<12}{:<12}{:<12}".format(u"I\u0304\u0304", u"am\u0304\u0304", u"W\u0304ayne\u0304!"))
	print("{0}{1}{2}".format(u"I\u0304\u0304".ljust(12), u"am\u0304\u0304".ljust(12), u"W\u0304ayne\u0304!".ljust(12)))